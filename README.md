...
```shell
helm upgrade --install -n voltha1 bbsim10 onf/bbsim --set olt_id=10
```
...
sudo wget https://github.com/opencord/voltctl/releases/download/v1.3.0/voltctl-1.3.0--$HOSTOS-$HOSTARCH -O /usr/local/bin/voltctl
