...
## Create secrets for elasticsearch and kibana.Secrets can be used by elasticsearch to create new user and templates.Kibana and fluentd use these secrets to login to elasticsearch
